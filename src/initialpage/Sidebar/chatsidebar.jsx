          ...
          <ul>
            ...
            <li>
              ...
              >
                ...
                <span className="chat-user">Prateek Tiwari</span>{' '}
            ...
            <li>
              ...
              >
                ...
                <span className="chat-user">Shital Agarwal</span>{' '}
            ...
            <li>
              ...
              >
                ...
                <span className="chat-user">Harvinder</span>
              </Link>
            </li>
            <li className="active">
              <Link
              ...
              >
                ...
                <span className="chat-user">Shreya Singh</span>{' '}
