          ...
          <section className="comp-section comp-buttons" id="comp_buttons">
            ...
            <div>
              ...
              <p>
                ...
                <button type="button" className="btn btn-secondary btn-lg mr-1">
                  Secondary
                </button>
                <button type="button" className="btn btn-success btn-lg mr-1">
                  Success
                </button>
                <button type="button" className="btn btn-danger btn-lg mr-1">
                  Danger
                </button>
                <button type="button" className="btn btn-warning btn-lg mr-1">
                  Warning
                </button>
                ...
                <button type="button" className="btn btn-dark btn-lg mr-1">
                  Dark
                </button>
              </p>
              <p>
              ...
              <p>
                ...
                <button type="button" className="btn btn-light btn-sm mr-1">
                  Light
                </button>
                ...
                <div className="card flex-fill">
                  <div className="card-header">
                    ...
                    >
                      ...
                      <li className="nav-item">
                        <a href="#tab-2" data-toggle="tab" className="nav-link">
                          Link
                        </a>
                      </li>
                      <li className="nav-item">
                ...
                <div className="card flex-fill">
                  <div className="card-header">
                    ...
                    >
                      ...
                      <li className="nav-item">
                        <a href="#tab-5" data-toggle="tab" className="nav-link">
                          Link
                        </a>
                      </li>
                      <li className="nav-item">
          ...
          <section className="comp-section comp-dropdowns" id="comp_dropdowns">
            ...
            <div>
              ...
              <div className="btn-group">
                ...
                <button
                  type="button"
                  className="btn btn-info dropdown-toggle dropdown-toggle-split mr-1"
                  data-toggle="dropdown"
                  aria-haspopup="true"
                  aria-expanded="false"
                >
              ...
              <div className="btn-group">
                ...
                <button
                  type="button"
                  className="btn btn-success dropdown-toggle dropdown-toggle-split mr-1"
                  data-toggle="dropdown"
                  aria-haspopup="true"
                  aria-expanded="false"
                >
              ...
              <div className="btn-group">
                ...
                <button
                  type="button"
                  className="btn btn-warning dropdown-toggle dropdown-toggle-split mr-1"
                  data-toggle="dropdown"
                  aria-haspopup="true"
                  aria-expanded="false"
                >
              ...
              <div className="btn-group">
                ...
                <button
                  type="button"
                  className="btn btn-danger dropdown-toggle dropdown-toggle-split mr-1"
                  data-toggle="dropdown"
                  aria-haspopup="true"
                  aria-expanded="false"
                >
