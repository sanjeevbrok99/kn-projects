                  ...
                  <div className="card">
                    <div className="card-body">
                      ...
                      <LineChart data={linechartdata}
                        ...
                        <Tooltip />
                        <Legend />
                        <Line type="monotone" dataKey="Total Sales" stroke="#f43b48" fill="#f43b48" strokeWidth={3} dot={{r : 3}} activeDot={{ r: 7 }} />
                        <Line type="monotone" dataKey="Total Revenue" stroke="#453a94" fill="#453a94" strokeWidth={3} dot={{r : 3}} activeDot={{ r: 7 }} />
                      </LineChart>
                      </ResponsiveContainer>
