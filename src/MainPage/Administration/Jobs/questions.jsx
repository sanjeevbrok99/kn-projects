                      ...
                      <div style={{ display: 'none' }} className="navbar">
                        <div className="navbar-inner">
                          <ul className="nav nav-pills">
                            ...
                            <li className="">
                              <a href="#step7" data-toggle="tab" data-step={7}>
                                Step 7
                              </a>
                            </li>
                            <li className="">
                              <a href="#step8" data-toggle="tab" data-step={8}>
                                Step 8
                              </a>
                            </li>
                            <li className="">
                              <a href="#step9" data-toggle="tab" data-step={9}>
                                Step 9
                              </a>
                            </li>
                            <li className="">
                            ...
                            <div className="row">
                              <div className="col-md-12">
                                ...
                                <button
                                  ...
                                  data-toggle="modal"
                                  data-target="#free_question_modal"
                                  type="button"
                                >
                                  Finish
                                </button>
